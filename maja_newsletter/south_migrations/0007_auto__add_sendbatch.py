...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('maja_newsletter', ['SendBatch'])
    ...
    models = {
        ...
        'maja_newsletter.sendbatch': {
            ...
            'server': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maja_newsletter.SMTPServer']"})
        },
