...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_newsletter_subscriptionformplugin', (
        ...
        db.send_create_signal('cmsplugin_newsletter', ['SubscriptionFormPlugin'])


    def backwards(self, orm):
        # Deleting model 'SubscriptionFormPlugin'
        db.delete_table('cmsplugin_newsletter_subscriptionformplugin')
