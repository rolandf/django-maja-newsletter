...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if LooseVersion(cms.__version__) >= LooseVersion('3'):
            if 'cmsplugin_subscriptionformplugin' in connection.introspection.table_names():
                db.rename_table('cmsplugin_subscriptionformplugin', 'cmsplugin_newsletter_subscriptionformplugin')
    ...
    def backwards(self, orm):
        ...
        if LooseVersion(cms.__version__) >= LooseVersion('3'):
            if 'cmsplugin_newsletter_subscriptionformplugin' in connection.introspection.table_names():
                db.rename_table('cmsplugin_newsletter_subscriptionformplugin', 'cmsplugin_subscriptionformplugin')
    ...
    models = {
        ...
        'cmsplugin_newsletter.subscriptionformplugin': {
